...
\cventry{November 2022 -- now}{Lead Developer}{Yandex Schoolbook}{}{}{
 ...
 \begin{itemize}
    ...
    \item \textbf{LLM Quality Assessment Project Lead}: Led a project to collect data for assessing LLM quality across various educational tasks, including school mathematics, informatics, and olympiad problems. Clarified project objectives, defined the methodology, and managed a mini-team of two members.
    ...
    \item \textbf{Refactored Skill-Based Statistics}: Improved skill-based statistics for parents and teachers, enhancing user experience and providing valuable insights into student performance.
    \item \textbf{Skill Graph Refactoring}: Analyzed and refactored a legacy algorithm for the skill graph module. Rewrote the system using modern technologies and integrated it with a new data source, enhancing performance and maintainability.
